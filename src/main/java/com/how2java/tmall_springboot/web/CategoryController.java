...
public class CategoryController {
    ...
    public void add(Category bean, MultipartFile image, HttpServletRequest request) throws Exception{
    ...
    public  Category get(@PathVariable("id") int id, HttpServletRequest request) throws  Exception{
